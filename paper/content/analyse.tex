...
Bei der Zielgruppe handelt es sich um erfahrene Entwickler, die mit dem Simulator ihre Anwendungen im Bereich Context Awareness testen möchten. Insbesondere wollen die Entwickler des MACK Frameworks dieses und seine Reasoner testen.

Die Benutzer haben mindestens grundlegende Kenntnisse in Java und XML und legen besonderen Wert auf detalierte Logausgaben.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
Dort zu sehen ins das untere Paket für die MATe-Simulation. Darin: der eigentliche \codeclass{World\-Generator}, welcher die zu generierenden Teile durch Aufrufe von statischen Methoden an die andere Klassen delegiert. Hier gezeigt durch gestrichelten blauen Linien.
Die jeweilen Klassen (alle als \codeinline{static} deklariert), arbeiten dann die in ihnen beschriebenen Java-Ausdrücke ab.
...
Als letzen Schritt nimmt der Generator alle Komponenten (rote Pfeile) und erzeugt daraus ein \codeclass{World}-Objekt.

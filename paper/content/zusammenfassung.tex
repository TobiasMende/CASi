...
Eine in der Analyse festgestellte Anforderung an unsere Software war die Möglichkeit, Simulationen durch eine Beschreibungssprache zu erzeugen. Im frühen Stadium unserer Arbeit haben wir uns, mit Hilfe der befragten Benutzer, für XML entschieden. Es sollte eine XML-Spezifkation in Form einer XML-Schema-Datei festgelegt werden. Unter dem Namen \codeinline{CASiX} wurde ein erste Version spezifiziert.

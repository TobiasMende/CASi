...
\lstset{frame=single,language=pascal,captionpos=b,nolol=false}
...
Ziel des Projektes ist es, eine Simulation zu entwickeln, mit der das MACK Framework und die Reasoner ohne Hardware getestet werden können. Hierfür entwickeln wir zunächst ein abstraktes Simulationsframework, mit dem verschiedene Simulationen entwickelt und simuliert werden können.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Schlüsselwörter} Simulator, Context Awareness
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Keywords} Context awareness, Simulator
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
